...
export class ORM1685096778693 implements MigrationInterface {
  name = 'ORM1685096778693'

  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(`CREATE TABLE "account" ("id" SERIAL NOT NULL, "user_name" character varying(50) NOT NULL, "password" character varying(100) NOT NULL, "note" character varying(100) NOT NULL, CONSTRAINT "PK_54115ee388cdb6d86bb4bf5b2ea" PRIMARY KEY ("id"))`);
    ...
    await queryRunner.query(`CREATE TABLE "earthwork_excavator" ("id" SERIAL NOT NULL, "earthId" integer NOT NULL, "type" character varying(20) NOT NULL, "name" character varying(20) NOT NULL, "qty" smallint NOT NULL, CONSTRAINT "PK_cdcb4fa7f2cc5d7e9adaabd6e51" PRIMARY KEY ("id"))`);
    ...
    await queryRunner.query(`CREATE TABLE "steel_and_form_detail" ("id" SERIAL NOT NULL, "steel_and_form_id" integer NOT NULL, "type" character varying(20) NOT NULL, "name" character varying(20) NOT NULL, "qty" smallint NOT NULL, CONSTRAINT "PK_52adf9175a8d529e3358d46860d" PRIMARY KEY ("id"))`);
  }
